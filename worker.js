        ...
        <main>
            <section class="search-section">
                <form id="searchForm" class="search-form">
                    ...
                    <div class="input-group">
                        <label for="days">Dagar bak̴t</label>
